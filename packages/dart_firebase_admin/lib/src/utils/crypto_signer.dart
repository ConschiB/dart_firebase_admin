...
class _IAMSigner implements CryptoSigner {
  ...
  Future<String> getAccountId() async {
    if (_serviceAccountId case final serviceAccountId? when serviceAccountId.isNotEmpty) {
...
class _ServiceAccountSigner implements CryptoSigner {
  ...
  Future<Uint8List> sign(Uint8List buffer) async {
    ...
    final signer = Signer('SHA-256/RSA')..init(true, PrivateKeyParameter<RSAPrivateKey>(rsaPrivateKey));
